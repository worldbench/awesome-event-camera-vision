...
PRE-Mamba~\cite{li2025premamba} (ICCV 2025) introduced a 4D state space model for ultra-high-frequency event camera deraining, processing events at their native microsecond resolution to achieve superior rain streak removal. Recent work extends to de-snowing for autonomous driving~\cite{zhang2025desnowing}, addressing the distinct challenge of snow flakes that produce larger, more diffuse event clusters than rain drops.
